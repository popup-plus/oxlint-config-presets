...
`vitest/no-restricted-vi-methods`, `vitest/padding-around-after-all-blocks`, `vitest/padding-around-after-each-blocks`, `vitest/padding-around-all`, `vitest/padding-around-before-all-blocks`, `vitest/padding-around-before-each-blocks`, `vitest/padding-around-describe-blocks`, `vitest/padding-around-expect-groups`, `vitest/padding-around-test-blocks`, `vitest/prefer-expect-assertions`, `vitest/prefer-importing-vitest-globals`, `vitest/prefer-snapshot-hint`, `vitest/valid-expect-in-promise`
